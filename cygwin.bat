...
rem call utils\chocolatey-pkg-ins.bat notepadplusplus
rem call utils\chocolatey-pkg-ins.bat googlechrome

rem call utils\chocolatey-pkg-ins.bat git.install
rem call utils\chocolatey-pkg-ins.bat winmerge

call utils\chocolatey-pkg-ins.bat cygwin
